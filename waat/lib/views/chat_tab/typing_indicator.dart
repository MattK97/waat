...
class TypingIndicator extends StatefulWidget {
  const TypingIndicator({
    ...
    this.flashingCircleBrightColor = const Color(0xFFaec1dd), this.width, this.height,
  }) : super(key: key);
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: Color.lerp(widget.flashingCircleDarkColor, widget.flashingCircleBrightColor,
                circleColorPercent),
          ),
        );
      },
